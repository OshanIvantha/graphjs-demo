 ...
 */
var StackedBarChart = function (_Chart) {
	_inherits(StackedBarChart, _Chart);
  ...
  */
	function StackedBarChart(data) {
		...
		var _this = _possibleConstructorReturn(this, (StackedBarChart.__proto__ || Object.getPrototypeOf(StackedBarChart)).call(this, data));

		_this._outputJson.data.type = 'bar';
		return _this;
	}
  ...
  */
	...
	_createClass(StackedBarChart, [{
		...
		value: function _do(grammar) {
			if (!_get(StackedBarChart.prototype.__proto__ || Object.getPrototypeOf(StackedBarChart.prototype), 'do', this).call(this, grammar)) {
				if (grammar.match(new RegExp('group [0-9a-zA-Z\\-]+[\\s]*(,[\\s]*)+[0-9a-zA-Z\\-]+'))) {
					var labelList = grammar.match(new RegExp(' [0-9a-zA-Z\\-]+[\\s]*(,[\\s]*)+[0-9a-zA-Z\\-]+'))[0].split(',');
					labelList = labelList.map(function (e) {
						return e.trim();
					});
