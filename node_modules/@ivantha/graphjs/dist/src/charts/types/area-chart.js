...
var AreaChart = function (_Chart) {
  ...
  */
	function AreaChart(data) {
		...
		return _possibleConstructorReturn(this, (AreaChart.__proto__ || Object.getPrototypeOf(AreaChart)).call(this, data));
	}
  ...
  */
	...
	_createClass(AreaChart, [{
		...
		value: function _do(grammar) {
			if (!_get(AreaChart.prototype.__proto__ || Object.getPrototypeOf(AreaChart.prototype), 'do', this).call(this, grammar)) {
				if (grammar.match(new RegExp('where [0-9a-zA-Z\\-]+ as area-spline'))) {
					var areaSplineDataLabel = grammar.match(new RegExp('where [0-9a-zA-Z\\-]+ as area-spline'))[0].split(' ')[1];
					this._outputJson.data.types[areaSplineDataLabel] = 'area-spline';
					return true;
				} else if (grammar.match(new RegExp('where [0-9a-zA-Z\\-]+ as area'))) {
					var areaDataLabel = grammar.match(new RegExp('where [0-9a-zA-Z\\-]+ as area'))[0].split(' ')[1];
