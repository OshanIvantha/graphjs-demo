...
var StepChart = function (_Chart) {
  ...
  */
	function StepChart(data) {
		...
		return _possibleConstructorReturn(this, (StepChart.__proto__ || Object.getPrototypeOf(StepChart)).call(this, data));
	}
  ...
  */
	...
	_createClass(StepChart, [{
		key: 'do',
		value: function _do(grammar) {
			if (!_get(StepChart.prototype.__proto__ || Object.getPrototypeOf(StepChart.prototype), 'do', this).call(this, grammar)) {
